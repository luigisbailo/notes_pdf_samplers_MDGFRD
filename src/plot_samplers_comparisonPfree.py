...
plt.plot (data[:,0],data[:,3], color='#446280', label=r"$g_{\Omega}(r,t),\quad t=\frac{b^2}{10D}$")
plt.plot (data[::20,0],data[::20,4], 'x', color='#446280', label=r"$p_{free}(r,t),\quad t=\frac{b^2}{10D}$" )
