...
ax_p.bar(data_pP[:, 0], data_pP[:, 1], bar_width, label=r"$p_\Omega(r,t),\thinspace t=\frac{b^2}{D}$", color='#3366CC')
ax_P.bar(data_pP[:, 0], data_pP[:, 2], bar_width, label=r"$P_\Omega(r,t),\thinspace t=\frac{b^2}{D}$", color='#3366CC')
...
ax_p.bar(data_pP[:, 0], data_pP[:, 1], bar_width, label=r"$p_\Omega(r,t),\thinspace t=\frac{b^2}{10*D}$", color='#3366CC')
ax_P.bar(data_pP[:, 0], data_pP[:, 2], bar_width, label=r"$P_\Omega(r,t),\thinspace t=\frac{b^2}{10*D}$", color='#3366CC')
ax_p.legend(loc=(loc_x,loc_y))
ax_P.legend(loc=(loc_x,loc_y))
ax_p.set_xlabel('r')
ax_P.set_xlabel('r')
...
ax_p.bar(data_pP[:, 0], data_pP[:, 1], bar_width, label=r"$p_\Omega(r,t),\thinspace t=\frac{b^2}{100*D}$", color='#3366CC')
ax_P.bar(data_pP[:, 0], data_pP[:, 2], bar_width, label=r"$P_\Omega(r,t),\thinspace t=\frac{b^2}{100*D}$", color='#3366CC')
ax_p.legend(loc=(loc_x,loc_y))
ax_P.legend(loc=(loc_x,loc_y))
ax_p.set_ylabel(r'$j^*$')
ax_P.set_yticklabels([])
